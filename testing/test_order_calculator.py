...
def test_order_calculator_calculate_subtotal_of_multiple_items():
    order_calculator = OrderCalculator()
    item1 = ("Apple", 1.5, 5)
    item2 = ("Pear", 2.5, 2)
    item3 = ("Plum", 0.5, 6)
    ...
    subtotal = order_calculator.calculate_subtotal()
    assert subtotal == 15.5


def test_order_calculator_calculate_subtotal_one_item():
    order_calculator = OrderCalculator()
    item1 = ("Apple", 1.5, 5)
    order_calculator.add_item(item1)
    subtotal = order_calculator.calculate_subtotal()
